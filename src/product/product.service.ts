...
export class ProductService {
    ...
    async getProductsByCategory(categoryName: string) {
        const products = await this.productRepository.getProductsByCategory(categoryName);
    ...
    async getProductDetail(productId: number){
        ...
        const productDetail = {
            ...
            categoryId: product.ProductCategory.map(category => category.Category.categoryId),
            categoryName: product.ProductCategory.map(category => category.Category.categoryName)
            }
